...
if __name__ == "__main__":
    ...
    dic_todo = {"TODO":[
                    ...
                    {"model": "llama-3.1-70B",
                     "folders_response_json":[f"./src/llama/Lucca_text/responses/3.1.llama.70B.Instruct/{temp}/" for temp in temp_values_OLBIA_LLAMA],
                     "temperatures": temp_values_OLBIA_LLAMA,
                     "checklists_json":"src/txt/Lucca/checklists/checklists.json",
                     "csv_determine":"src/txt/Lucca/checklists/Lucca_Determine.csv",
                     "municipality":LUCCA,
                    ...
                    {"model": "llama-3.1-70B",
                     "folders_response_json":[f"./src/llama/Olbia_text/responses/3.1.llama.70B.Instruct/{temp}/" for temp in temp_values_OLBIA_LLAMA],
                     "temperatures": temp_values_OLBIA_LLAMA,
                     "checklists_json":"src/txt/Olbia/checklists/checklists.json",
                     "csv_determine":"src/txt/Olbia/checklists/Olbia_Determine.csv",
                     "municipality":OLBIA,
                    ...
                    {"model": "llama-3.3-70B",
                     "folders_response_json":[f"./src/llama/Lucca_text/responses/3.3.llama.70B.Instruct/{temp}/" for temp in temp_values_LUCCA_LLAMA],
                     "temperatures": temp_values_LUCCA_LLAMA,
                     "checklists_json":"src/txt/Lucca/checklists/checklists.json",
                     "csv_determine":"src/txt/Lucca/checklists/Lucca_Determine.csv",
                     "municipality":LUCCA,
                    ...
                    {"model": "Mistral-v0.3-7B",
                     "folders_response_json":[f"./src/llama/Lucca_text/responses/Mistral.7B.Instruct-v0.3/{temp}/" for temp in temp_values_LUCCA_LLAMA],
                     "temperatures": temp_values_LUCCA_LLAMA,
                     "checklists_json":"src/txt/Lucca/checklists/checklists.json",
                     "csv_determine":"src/txt/Lucca/checklists/Lucca_Determine.csv",
                     "municipality":LUCCA,
                    ...
                    {"model": "Mistral-v0.3-7B",
                     "folders_response_json":[f"./src/llama/Olbia_text/responses/Mistral.7B.Instruct-v0.3/{temp}/" for temp in temp_values_LUCCA_LLAMA],
                     "temperatures": temp_values_LUCCA_LLAMA,
                     "checklists_json":"src/txt/Olbia/checklists/checklists.json",
                     "csv_determine":"src/txt/Olbia/checklists/Olbia_Determine.csv",
                     "municipality":OLBIA,
